...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle b) {		
		...
		if (android.os.Build.VERSION.SDK_INT >= 30) {    
		    TEXT_INTRO += "\n\nЕсли выдать этому приложению права Device Owner или COPE, оно сможет отключить FRP.";
			TEXT_INTRO_EN += "\n\nIf grant this app Device Owner or COPE rights, it can disable FRP.";
		} else {
		    TEXT_INTRO += "\n\nЕсли выдать этому приложению права Device Owner, оно сможет отключить FRP.";
